...
<div class="panel hidden" id="woEmployeeSearchPanel">
	<div class="panel-head" id="woEmployeeSearchPanelHeader">
		<span class='icon-times float-right rotate'></span>
		<h4 class="icon-search">&nbsp;查询</h4>
	</div>
	<div class="panel-body padding-small" id="woEmployeeSearchPanelBody">
		<form onsubmit="return false;" class="form-inline" id="woEmployeeSearchForm">
...
<div class="panel" id="woEmployeeListPanel">
	<div class="panel-head" id="woEmployeeListPanelHeader">
		<form onsubmit="return false;">
			<span class='icon-search float-right' id="woEmployeeListPanelShowSearch" onclick="$('#woEmployeeSearchPanel').removeClass ('hidden')"></span>
			<h4>员工列表</h4>
		</form>
	</div>
	
	<div class="panel-body-little woPanelBody">
		<form method="post" id="woEmployeeListPanelHeaderForm">
			...
			<div id="woEmployeeListPanelBody">
				<!-- 点击查询按钮时，下面内容会被替换 -->

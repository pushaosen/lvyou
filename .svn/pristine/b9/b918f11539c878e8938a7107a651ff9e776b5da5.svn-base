...
<div class="panel hidden" id="woSiteSearchPanel">
	<div class="panel-head" id="woSiteSearchPanelHeader">
		<span class='icon-times float-right rotate'></span>
		<h4 class="icon-search">&nbsp;查询</h4>
	</div>
	<div class="panel-body padding-small" id="woSiteSearchPanelBody">
		<form onsubmit="return false;" class="form-inline" id="woSiteSearchForm">
			<div class="form-group">
				<div class="label">
					<label for="employName">&nbsp;&nbsp;&nbsp;&nbsp;景点名称</label>&nbsp;&nbsp;&nbsp;&nbsp;
				</div>
				<div class="field">
...
<div class="panel" id="woSiteListPanel">
	<div class="panel-head" id="woSiteListPanelHeader">
		<form onsubmit="return false;">
			<span class='icon-search float-right' id="woSiteListPanelShowSearch" onclick="$('#woSiteSearchPanel').removeClass ('hidden')"></span>
			<h4>景点列表</h4>
		</form>
	</div>
	
	<div class="panel-body-little woPanelBody">
		<form method="post" id="woSiteListPanelHeaderForm">
